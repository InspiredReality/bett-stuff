...
function LeagueStuffMain() {
  const navigate = useNavigate()
  const { navSections, activeMainButton, selectSubButton } = useNavigationStore()

  const sectionName = activeMainButton || 'League Stuff'
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(150px,1fr))] gap-4">
            {subButtons.map((sub) => (
              <button
                ...
                className="p-6 border-none rounded-xl text-lg font-semibold cursor-pointer transition-all duration-300 text-white hover:-translate-y-0.5 hover:shadow-lg"
...
export default LeagueStuffMain
